...
const routes = [
  {
    ...
    children: [
      ...
      { path: `${routeNames.games}/genre/all`, element: <GamesPage /> },
      { path: `${routeNames.games}/:type/:id`, element: <GenrePage /> },
      { path: `${routeNames.games}/search/:id`, element: <SearchPage /> },
      { path: `${routeNames.games}/detail/:id`, element: <GameDetails /> },
